...
def get_radar(item):
    ...
    for place in radar:
        ...
        if summ >= max_num:
            break
        if district_num >= max_district_num:
            district_num = 0
            break
...
def run(_params):
    ...
    :return:
    """
    global params, g_places, q_radar, q_detail, results, summ, max_num, district_num, max_district_num
    ...
    params = _params
    max_district_num = params["max_district_num"]
